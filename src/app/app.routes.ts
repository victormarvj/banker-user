...
export const routes: Routes = [
  ...
  },
  {
    ...
    title: 'Getting Started | PrivateWealthHolders.com',
  },
  {
    path: 'signin',
    component: SignInComponent,
    title: 'Sign In | PrivateWealthHolders.com',
  },
  {
    path: 'signup',
    component: SignUpComponent,
    title: 'Sign Up | PrivateWealthHolders.com',
  },
  {
    path: 'forgot-password',
    component: ForgotPasswordComponent,
    title: 'Forgot Password | PrivateWealthHolders.com',
  },
  {
    path: 'verify-email',
    component: VerifyEmailComponent,
    title: 'Verify Email | PrivateWealthHolders.com',
  },
  {
    path: 'transaction-pin',
    component: TransactionPinComponent,
    title: 'Transaction Pin | PrivateWealthHolders.com',
  },
  {
    path: 'identity-verification',
    component: IdentityVerificationComponent,
    title: 'Identity Verification | PrivateWealthHolders.com',
  },
  {
    path: 'dashboard',
    ...
    children: [
      ...
      },
      {
        ...
        title: 'Dashboard | PrivateWealthHolders.com',
      },
      {
        path: 'domestic',
        component: DomesticComponent,
        title: 'Domestic Transfer | PrivateWealthHolders.com',
      },
      {
        path: 'international',
        component: InternationalComponent,
        title: 'International | PrivateWealthHolders.com',
      },
      {
        path: 'domestic-europe',
        component: DomesticEuropeComponent,
        title: 'Domestic Europe | PrivateWealthHolders.com',
      },
      {
        path: 'incomplete-transaction',
        component: IncompleteTransactionComponent,
        title: 'Incomplete Transaction | PrivateWealthHolders.com',
      },
      {
        path: 'deposit',
        component: DepositComponent,
        title: 'Deposit | PrivateWealthHolders.com',
      },
      {
        path: 'deposit-history',
        component: DepositHistoryComponent,
        title: 'Deposit History | PrivateWealthHolders.com',
      },
      {
        path: 'withdrawal',
        component: WithdrawalComponent,
        title: 'Withdrawal | PrivateWealthHolders.com',
      },
      {
        path: 'withdrawal-history',
        component: WithdrawalHistoryComponent,
        title: 'Withdrawal History | PrivateWealthHolders.com',
      },
      {
        path: 'transactions',
        component: TransactionsComponent,
        title: 'Transactions | PrivateWealthHolders.com',
      },
      {
        path: 'investments',
        component: InvestmentsComponent,
        title: 'Investments | PrivateWealthHolders.com',
      },
      {
        path: 'credit-cards',
        component: CreditCardsComponent,
        title: 'Credit Cards | PrivateWealthHolders.com',
      },
      {
        path: 'loans',
        component: LoansComponent,
        title: 'Loans | PrivateWealthHolders.com',
      },
      {
        path: 'support',
        component: SupportComponent,
        title: 'Support | PrivateWealthHolders.com',
      },
      {
        path: 'services',
        component: ServicesComponent,
        title: 'Services | PrivateWealthHolders.com',
      },
      {
        path: 'privileges',
        component: PrivilegesComponent,
        title: 'Privileges | PrivateWealthHolders.com',
      },
      {
        path: 'settings',
        component: SettingsComponent,
        title: 'Settings | PrivateWealthHolders.com',
      },
      {
        path: 'success/:transactionId',
        component: SuccessComponent,
        title: 'Transaction Success | PrivateWealthHolders.com',
      },
    ],
  },
  {
