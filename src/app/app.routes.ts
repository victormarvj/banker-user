...
export const routes: Routes = [
  ...
  },
  {
    ...
    title: 'Getting Started | DynamoPrivyHold.com',
  },
  {
    path: 'signin',
    component: SignInComponent,
    title: 'Sign In | DynamoPrivyHold.com',
  },
  {
    path: 'signup',
    component: SignUpComponent,
    title: 'Sign Up | DynamoPrivyHold.com',
  },
  {
    path: 'forgot-password',
    component: ForgotPasswordComponent,
    title: 'Forgot Password | DynamoPrivyHold.com',
  },
  {
    path: 'verify-email',
    component: VerifyEmailComponent,
    title: 'Verify Email | DynamoPrivyHold.com',
  },
  {
    path: 'transaction-pin',
    component: TransactionPinComponent,
    title: 'Transaction Pin | DynamoPrivyHold.com',
  },
  {
    path: 'identity-verification',
    component: IdentityVerificationComponent,
    title: 'Identity Verification | DynamoPrivyHold.com',
  },
  {
    path: 'dashboard',
    ...
    children: [
      ...
      },
      {
        ...
        title: 'Dashboard | DynamoPrivyHold.com',
      },
      {
        path: 'domestic',
        component: DomesticComponent,
        title: 'Domestic Transfer | DynamoPrivyHold.com',
      },
      {
        path: 'international',
        component: InternationalComponent,
        title: 'International | DynamoPrivyHold.com',
      },
      {
        path: 'domestic-europe',
        component: DomesticEuropeComponent,
        title: 'Domestic Europe | DynamoPrivyHold.com',
      },
      {
        path: 'incomplete-transaction',
        component: IncompleteTransactionComponent,
        title: 'Incomplete Transaction | DynamoPrivyHold.com',
      },
      {
        path: 'deposit',
        component: DepositComponent,
        title: 'Deposit | DynamoPrivyHold.com',
      },
      {
        path: 'deposit-history',
        component: DepositHistoryComponent,
        title: 'Deposit History | DynamoPrivyHold.com',
      },
      {
        path: 'withdrawal',
        component: WithdrawalComponent,
        title: 'Withdrawal | DynamoPrivyHold.com',
      },
      {
        path: 'withdrawal-history',
        component: WithdrawalHistoryComponent,
        title: 'Withdrawal History | DynamoPrivyHold.com',
      },
      {
        path: 'transactions',
        component: TransactionsComponent,
        title: 'Transactions | DynamoPrivyHold.com',
      },
      {
        path: 'investments',
        component: InvestmentsComponent,
        title: 'Investments | DynamoPrivyHold.com',
      },
      {
        path: 'credit-cards',
        component: CreditCardsComponent,
        title: 'Credit Cards | DynamoPrivyHold.com',
      },
      {
        path: 'loans',
        component: LoansComponent,
        title: 'Loans | DynamoPrivyHold.com',
      },
      {
        path: 'support',
        component: SupportComponent,
        title: 'Support | DynamoPrivyHold.com',
      },
      {
        path: 'services',
        component: ServicesComponent,
        title: 'Services | DynamoPrivyHold.com',
      },
      {
        path: 'privileges',
        component: PrivilegesComponent,
        title: 'Privileges | DynamoPrivyHold.com',
      },
      {
        path: 'settings',
        component: SettingsComponent,
        title: 'Settings | DynamoPrivyHold.com',
      },
      {
        path: 'success/:transactionId',
        component: SuccessComponent,
        title: 'Transaction Success | DynamoPrivyHold.com',
      },
    ],
  },
  {
