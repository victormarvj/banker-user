...
export const routes: Routes = [
  ...
  },
  {
    ...
    title: 'Getting Started | ZenaTopThrust.com',
  },
  {
    path: 'signin',
    component: SignInComponent,
    title: 'Sign In | ZenaTopThrust.com',
  },
  {
    path: 'signup',
    component: SignUpComponent,
    title: 'Sign Up | ZenaTopThrust.com',
  },
  {
    path: 'forgot-password',
    component: ForgotPasswordComponent,
    title: 'Forgot Password | ZenaTopThrust.com',
  },
  {
    path: 'verify-email',
    component: VerifyEmailComponent,
    title: 'Verify Email | ZenaTopThrust.com',
  },
  {
    path: 'transaction-pin',
    component: TransactionPinComponent,
    title: 'Transaction Pin | ZenaTopThrust.com',
  },
  {
    path: 'identity-verification',
    component: IdentityVerificationComponent,
    title: 'Identity Verification | ZenaTopThrust.com',
  },
  {
    path: 'dashboard',
    ...
    children: [
      ...
      },
      {
        ...
        title: 'Dashboard | ZenaTopThrust.com',
      },
      {
        path: 'domestic',
        component: DomesticComponent,
        title: 'Domestic Transfer | ZenaTopThrust.com',
      },
      {
        path: 'international',
        component: InternationalComponent,
        title: 'International | ZenaTopThrust.com',
      },
      {
        path: 'domestic-europe',
        component: DomesticEuropeComponent,
        title: 'Domestic Europe | ZenaTopThrust.com',
      },
      {
        path: 'incomplete-transaction',
        component: IncompleteTransactionComponent,
        title: 'Incomplete Transaction | ZenaTopThrust.com',
      },
      {
        path: 'deposit',
        component: DepositComponent,
        title: 'Deposit | ZenaTopThrust.com',
      },
      {
        path: 'deposit-history',
        component: DepositHistoryComponent,
        title: 'Deposit History | ZenaTopThrust.com',
      },
      {
        path: 'withdrawal',
        component: WithdrawalComponent,
        title: 'Withdrawal | ZenaTopThrust.com',
      },
      {
        path: 'withdrawal-history',
        component: WithdrawalHistoryComponent,
        title: 'Withdrawal History | ZenaTopThrust.com',
      },
      {
        path: 'transactions',
        component: TransactionsComponent,
        title: 'Transactions | ZenaTopThrust.com',
      },
      {
        path: 'investments',
        component: InvestmentsComponent,
        title: 'Investments | ZenaTopThrust.com',
      },
      {
        path: 'credit-cards',
        component: CreditCardsComponent,
        title: 'Credit Cards | ZenaTopThrust.com',
      },
      {
        path: 'loans',
        component: LoansComponent,
        title: 'Loans | ZenaTopThrust.com',
      },
      {
        path: 'support',
        component: SupportComponent,
        title: 'Support | ZenaTopThrust.com',
      },
      {
        path: 'services',
        component: ServicesComponent,
        title: 'Services | ZenaTopThrust.com',
      },
      {
        path: 'privileges',
        component: PrivilegesComponent,
        title: 'Privileges | ZenaTopThrust.com',
      },
      {
        path: 'settings',
        component: SettingsComponent,
        title: 'Settings | ZenaTopThrust.com',
      },
      {
        path: 'success/:transactionId',
        component: SuccessComponent,
        title: 'Transaction Success | ZenaTopThrust.com',
      },
    ],
  },
  {
