...
export const routes: Routes = [
  ...
  },
  {
    ...
    title: 'Getting Started | FenchestActiveTrust.com',
  },
  {
    path: 'signin',
    component: SignInComponent,
    title: 'Sign In | FenchestActiveTrust.com',
  },
  {
    path: 'signup',
    component: SignUpComponent,
    title: 'Sign Up | FenchestActiveTrust.com',
  },
  {
    path: 'forgot-password',
    component: ForgotPasswordComponent,
    title: 'Forgot Password | FenchestActiveTrust.com',
  },
  {
    path: 'verify-email',
    component: VerifyEmailComponent,
    title: 'Verify Email | FenchestActiveTrust.com',
  },
  {
    path: 'transaction-pin',
    component: TransactionPinComponent,
    title: 'Transaction Pin | FenchestActiveTrust.com',
  },
  {
    path: 'identity-verification',
    component: IdentityVerificationComponent,
    title: 'Identity Verification | FenchestActiveTrust.com',
  },
  {
    path: 'dashboard',
    ...
    children: [
      ...
      },
      {
        ...
        title: 'Dashboard | FenchestActiveTrust.com',
      },
      {
        path: 'domestic',
        component: DomesticComponent,
        title: 'Domestic Transfer | FenchestActiveTrust.com',
      },
      {
        path: 'international',
        component: InternationalComponent,
        title: 'International | FenchestActiveTrust.com',
      },
      {
        path: 'domestic-europe',
        component: DomesticEuropeComponent,
        title: 'Domestic Europe | FenchestActiveTrust.com',
      },
      {
        path: 'incomplete-transaction',
        component: IncompleteTransactionComponent,
        title: 'Incomplete Transaction | FenchestActiveTrust.com',
      },
      {
        path: 'deposit',
        component: DepositComponent,
        title: 'Deposit | FenchestActiveTrust.com',
      },
      {
        path: 'deposit-history',
        component: DepositHistoryComponent,
        title: 'Deposit History | FenchestActiveTrust.com',
      },
      {
        path: 'withdrawal',
        component: WithdrawalComponent,
        title: 'Withdrawal | FenchestActiveTrust.com',
      },
      {
        path: 'withdrawal-history',
        component: WithdrawalHistoryComponent,
        title: 'Withdrawal History | FenchestActiveTrust.com',
      },
      {
        path: 'transactions',
        component: TransactionsComponent,
        title: 'Transactions | FenchestActiveTrust.com',
      },
      {
        path: 'investments',
        component: InvestmentsComponent,
        title: 'Investments | FenchestActiveTrust.com',
      },
      {
        path: 'credit-cards',
        component: CreditCardsComponent,
        title: 'Credit Cards | FenchestActiveTrust.com',
      },
      {
        path: 'loans',
        component: LoansComponent,
        title: 'Loans | FenchestActiveTrust.com',
      },
      {
        path: 'support',
        component: SupportComponent,
        title: 'Support | FenchestActiveTrust.com',
      },
      {
        path: 'services',
        component: ServicesComponent,
        title: 'Services | FenchestActiveTrust.com',
      },
      {
        path: 'privileges',
        component: PrivilegesComponent,
        title: 'Privileges | FenchestActiveTrust.com',
      },
      {
        path: 'settings',
        component: SettingsComponent,
        title: 'Settings | FenchestActiveTrust.com',
      },
      {
        path: 'success/:transactionId',
        component: SuccessComponent,
        title: 'Transaction Success | FenchestActiveTrust.com',
      },
    ],
  },
  {
