...
export const routes: Routes = [
  ...
  },
  {
    ...
    title: 'Getting Started | WovenTallowHold.com',
  },
  {
    path: 'signin',
    component: SignInComponent,
    title: 'Sign In | WovenTallowHold.com',
  },
  {
    path: 'signup',
    component: SignUpComponent,
    title: 'Sign Up | WovenTallowHold.com',
  },
  {
    path: 'forgot-password',
    component: ForgotPasswordComponent,
    title: 'Forgot Password | WovenTallowHold.com',
  },
  {
    path: 'verify-email',
    component: VerifyEmailComponent,
    title: 'Verify Email | WovenTallowHold.com',
  },
  {
    path: 'transaction-pin',
    component: TransactionPinComponent,
    title: 'Transaction Pin | WovenTallowHold.com',
  },
  {
    path: 'identity-verification',
    component: IdentityVerificationComponent,
    title: 'Identity Verification | WovenTallowHold.com',
  },
  {
    path: 'dashboard',
    ...
    children: [
      ...
      },
      {
        ...
        title: 'Dashboard | WovenTallowHold.com',
      },
      {
        path: 'domestic',
        component: DomesticComponent,
        title: 'Domestic Transfer | WovenTallowHold.com',
      },
      {
        path: 'international',
        component: InternationalComponent,
        title: 'International | WovenTallowHold.com',
      },
      {
        path: 'domestic-europe',
        component: DomesticEuropeComponent,
        title: 'Domestic Europe | WovenTallowHold.com',
      },
      {
        path: 'incomplete-transaction',
        component: IncompleteTransactionComponent,
        title: 'Incomplete Transaction | WovenTallowHold.com',
      },
      {
        path: 'deposit',
        component: DepositComponent,
        title: 'Deposit | WovenTallowHold.com',
      },
      {
        path: 'deposit-history',
        component: DepositHistoryComponent,
        title: 'Deposit History | WovenTallowHold.com',
      },
      {
        path: 'withdrawal',
        component: WithdrawalComponent,
        title: 'Withdrawal | WovenTallowHold.com',
      },
      {
        path: 'withdrawal-history',
        component: WithdrawalHistoryComponent,
        title: 'Withdrawal History | WovenTallowHold.com',
      },
      {
        path: 'transactions',
        component: TransactionsComponent,
        title: 'Transactions | WovenTallowHold.com',
      },
      {
        path: 'investments',
        component: InvestmentsComponent,
        title: 'Investments | WovenTallowHold.com',
      },
      {
        path: 'credit-cards',
        component: CreditCardsComponent,
        title: 'Credit Cards | WovenTallowHold.com',
      },
      {
        path: 'loans',
        component: LoansComponent,
        title: 'Loans | WovenTallowHold.com',
      },
      {
        path: 'support',
        component: SupportComponent,
        title: 'Support | WovenTallowHold.com',
      },
      {
        path: 'services',
        component: ServicesComponent,
        title: 'Services | WovenTallowHold.com',
      },
      {
        path: 'privileges',
        component: PrivilegesComponent,
        title: 'Privileges | WovenTallowHold.com',
      },
      {
        path: 'settings',
        component: SettingsComponent,
        title: 'Settings | WovenTallowHold.com',
      },
      {
        path: 'success/:transactionId',
        component: SuccessComponent,
        title: 'Transaction Success | WovenTallowHold.com',
      },
    ],
  },
  {
