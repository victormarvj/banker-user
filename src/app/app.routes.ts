...
export const routes: Routes = [
  ...
  },
  {
    ...
    title: 'Getting Started | LunexaEdge.com',
  },
  {
    path: 'signin',
    component: SignInComponent,
    title: 'Sign In | LunexaEdge.com',
  },
  {
    path: 'signup',
    component: SignUpComponent,
    title: 'Sign Up | LunexaEdge.com',
  },
  {
    path: 'forgot-password',
    component: ForgotPasswordComponent,
    title: 'Forgot Password | LunexaEdge.com',
  },
  {
    path: 'verify-email',
    component: VerifyEmailComponent,
    title: 'Verify Email | LunexaEdge.com',
  },
  {
    path: 'transaction-pin',
    component: TransactionPinComponent,
    title: 'Transaction Pin | LunexaEdge.com',
  },
  {
    path: 'identity-verification',
    component: IdentityVerificationComponent,
    title: 'Identity Verification | LunexaEdge.com',
  },
  {
    path: 'dashboard',
    ...
    children: [
      ...
      },
      {
        ...
        title: 'Dashboard | LunexaEdge.com',
      },
      {
        path: 'domestic',
        component: DomesticComponent,
        title: 'Domestic Transfer | LunexaEdge.com',
      },
      {
        path: 'international',
        component: InternationalComponent,
        title: 'International | LunexaEdge.com',
      },
      {
        path: 'domestic-europe',
        component: DomesticEuropeComponent,
        title: 'Domestic Europe | LunexaEdge.com',
      },
      {
        path: 'incomplete-transaction',
        component: IncompleteTransactionComponent,
        title: 'Incomplete Transaction | LunexaEdge.com',
      },
      {
        path: 'deposit',
        component: DepositComponent,
        title: 'Deposit | LunexaEdge.com',
      },
      {
        path: 'deposit-history',
        component: DepositHistoryComponent,
        title: 'Deposit History | LunexaEdge.com',
      },
      {
        path: 'withdrawal',
        component: WithdrawalComponent,
        title: 'Withdrawal | LunexaEdge.com',
      },
      {
        path: 'withdrawal-history',
        component: WithdrawalHistoryComponent,
        title: 'Withdrawal History | LunexaEdge.com',
      },
      {
        path: 'transactions',
        component: TransactionsComponent,
        title: 'Transactions | LunexaEdge.com',
      },
      {
        path: 'investments',
        component: InvestmentsComponent,
        title: 'Investments | LunexaEdge.com',
      },
      {
        path: 'credit-cards',
        component: CreditCardsComponent,
        title: 'Credit Cards | LunexaEdge.com',
      },
      {
        path: 'loans',
        component: LoansComponent,
        title: 'Loans | LunexaEdge.com',
      },
      {
        path: 'support',
        component: SupportComponent,
        title: 'Support | LunexaEdge.com',
      },
      {
        path: 'services',
        component: ServicesComponent,
        title: 'Services | LunexaEdge.com',
      },
      {
        path: 'privileges',
        component: PrivilegesComponent,
        title: 'Privileges | LunexaEdge.com',
      },
      {
        path: 'settings',
        component: SettingsComponent,
        title: 'Settings | LunexaEdge.com',
      },
      {
        path: 'success/:transactionId',
        component: SuccessComponent,
        title: 'Transaction Success | LunexaEdge.com',
      },
    ],
  },
  {
