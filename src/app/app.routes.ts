...
export const routes: Routes = [
  ...
  },
  {
    ...
    title: 'Getting Started | CityApexGroup.com',
  },
  {
    path: 'signin',
    component: SignInComponent,
    title: 'Sign In | CityApexGroup.com',
  },
  {
    path: 'signup',
    component: SignUpComponent,
    title: 'Sign Up | CityApexGroup.com',
  },
  {
    path: 'forgot-password',
    component: ForgotPasswordComponent,
    title: 'Forgot Password | CityApexGroup.com',
  },
  {
    path: 'verify-email',
    component: VerifyEmailComponent,
    title: 'Verify Email | CityApexGroup.com',
  },
  {
    path: 'transaction-pin',
    component: TransactionPinComponent,
    title: 'Transaction Pin | CityApexGroup.com',
  },
  {
    path: 'identity-verification',
    component: IdentityVerificationComponent,
    title: 'Identity Verification | CityApexGroup.com',
  },
  {
    path: 'dashboard',
    ...
    children: [
      ...
      },
      {
        ...
        title: 'Dashboard | CityApexGroup.com',
      },
      {
        path: 'domestic',
        component: DomesticComponent,
        title: 'Domestic Transfer | CityApexGroup.com',
      },
      {
        path: 'international',
        component: InternationalComponent,
        title: 'International | CityApexGroup.com',
      },
      {
        path: 'domestic-europe',
        component: DomesticEuropeComponent,
        title: 'Domestic Europe | CityApexGroup.com',
      },
      {
        path: 'incomplete-transaction',
        component: IncompleteTransactionComponent,
        title: 'Incomplete Transaction | CityApexGroup.com',
      },
      {
        path: 'deposit',
        component: DepositComponent,
        title: 'Deposit | CityApexGroup.com',
      },
      {
        path: 'deposit-history',
        component: DepositHistoryComponent,
        title: 'Deposit History | CityApexGroup.com',
      },
      {
        path: 'withdrawal',
        component: WithdrawalComponent,
        title: 'Withdrawal | CityApexGroup.com',
      },
      {
        path: 'withdrawal-history',
        component: WithdrawalHistoryComponent,
        title: 'Withdrawal History | CityApexGroup.com',
      },
      {
        path: 'transactions',
        component: TransactionsComponent,
        title: 'Transactions | CityApexGroup.com',
      },
      {
        path: 'investments',
        component: InvestmentsComponent,
        title: 'Investments | CityApexGroup.com',
      },
      {
        path: 'credit-cards',
        component: CreditCardsComponent,
        title: 'Credit Cards | CityApexGroup.com',
      },
      {
        path: 'loans',
        component: LoansComponent,
        title: 'Loans | CityApexGroup.com',
      },
      {
        path: 'support',
        component: SupportComponent,
        title: 'Support | CityApexGroup.com',
      },
      {
        path: 'services',
        component: ServicesComponent,
        title: 'Services | CityApexGroup.com',
      },
      {
        path: 'privileges',
        component: PrivilegesComponent,
        title: 'Privileges | CityApexGroup.com',
      },
      {
        path: 'settings',
        component: SettingsComponent,
        title: 'Settings | CityApexGroup.com',
      },
      {
        path: 'success/:transactionId',
        component: SuccessComponent,
        title: 'Transaction Success | CityApexGroup.com',
      },
    ],
  },
  {
