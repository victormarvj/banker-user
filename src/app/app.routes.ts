...
export const routes: Routes = [
  ...
  },
  {
    ...
    title: 'Getting Started | OlivePremierInc.com',
  },
  {
    path: 'signin',
    component: SignInComponent,
    title: 'Sign In | OlivePremierInc.com',
  },
  {
    path: 'signup',
    component: SignUpComponent,
    title: 'Sign Up | OlivePremierInc.com',
  },
  {
    path: 'forgot-password',
    component: ForgotPasswordComponent,
    title: 'Forgot Password | OlivePremierInc.com',
  },
  {
    path: 'verify-email',
    component: VerifyEmailComponent,
    title: 'Verify Email | OlivePremierInc.com',
  },
  {
    path: 'transaction-pin',
    component: TransactionPinComponent,
    title: 'Transaction Pin | OlivePremierInc.com',
  },
  {
    path: 'identity-verification',
    component: IdentityVerificationComponent,
    title: 'Identity Verification | OlivePremierInc.com',
  },
  {
    path: 'dashboard',
    ...
    children: [
      ...
      },
      {
        ...
        title: 'Dashboard | OlivePremierInc.com',
      },
      {
        path: 'domestic',
        component: DomesticComponent,
        title: 'Domestic Transfer | OlivePremierInc.com',
      },
      {
        path: 'international',
        component: InternationalComponent,
        title: 'International | OlivePremierInc.com',
      },
      {
        path: 'domestic-europe',
        component: DomesticEuropeComponent,
        title: 'Domestic Europe | OlivePremierInc.com',
      },
      {
        path: 'incomplete-transaction',
        component: IncompleteTransactionComponent,
        title: 'Incomplete Transaction | OlivePremierInc.com',
      },
      {
        path: 'deposit',
        component: DepositComponent,
        title: 'Deposit | OlivePremierInc.com',
      },
      {
        path: 'deposit-history',
        component: DepositHistoryComponent,
        title: 'Deposit History | OlivePremierInc.com',
      },
      {
        path: 'withdrawal',
        component: WithdrawalComponent,
        title: 'Withdrawal | OlivePremierInc.com',
      },
      {
        path: 'withdrawal-history',
        component: WithdrawalHistoryComponent,
        title: 'Withdrawal History | OlivePremierInc.com',
      },
      {
        path: 'transactions',
        component: TransactionsComponent,
        title: 'Transactions | OlivePremierInc.com',
      },
      {
        path: 'investments',
        component: InvestmentsComponent,
        title: 'Investments | OlivePremierInc.com',
      },
      {
        path: 'credit-cards',
        component: CreditCardsComponent,
        title: 'Credit Cards | OlivePremierInc.com',
      },
      {
        path: 'loans',
        component: LoansComponent,
        title: 'Loans | OlivePremierInc.com',
      },
      {
        path: 'support',
        component: SupportComponent,
        title: 'Support | OlivePremierInc.com',
      },
      {
        path: 'services',
        component: ServicesComponent,
        title: 'Services | OlivePremierInc.com',
      },
      {
        path: 'privileges',
        component: PrivilegesComponent,
        title: 'Privileges | OlivePremierInc.com',
      },
      {
        path: 'settings',
        component: SettingsComponent,
        title: 'Settings | OlivePremierInc.com',
      },
      {
        path: 'success/:transactionId',
        component: SuccessComponent,
        title: 'Transaction Success | OlivePremierInc.com',
      },
    ],
  },
  {
